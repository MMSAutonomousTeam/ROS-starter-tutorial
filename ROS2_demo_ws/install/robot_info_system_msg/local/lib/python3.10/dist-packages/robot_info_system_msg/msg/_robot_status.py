...
class Metaclass_RobotStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('robot_info_system_msg')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'robot_info_system_msg.msg.RobotStatus')
            logger.debug(
...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    _fields_and_field_types = {
        'battery_level': 'std_msgs/Int32',
        'temperature': 'std_msgs/UInt8',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Int32
        self.battery_level = kwargs.get('battery_level', Int32())
        from std_msgs.msg import UInt8
        self.temperature = kwargs.get('temperature', UInt8())
    ...
    def battery_level(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'battery_level' field must be a sub message of type 'Int32'"
    ...
    def temperature(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'temperature' field must be a sub message of type 'UInt8'"
